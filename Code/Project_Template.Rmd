...
\newpage
### Florida 
Figure \@ref(fig:FLtimeseries) shows the time series analysis for outage occurrences across Florida from 2015 to 2023. A Mann-Kendall test was run to determine if distinct seasonal trends from the time series are statistically significant. Based
