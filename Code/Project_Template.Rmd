...
Figure \@ref(fig:nonseasall) visualizes each state’s non-seasonal power outage time series trend. Red represents California, green is Florida, purple is Pennsylvania, and blue is Texas. All states are seeing an increasing trend of power outages, this confirmed both visually and through each state's Mann–Kendall results. These results supports our first hypothesis that long-term pressures, such as extreme weather event, may be contributing to increases in the number of power outages. California and Texas are experiencing the greatest increase, while Pennsylvania and Florida are experiencing more gradual increases in comparison. Towards the end of the time period, California and Texas also overall have more power outages than Florida and Pennsylvania, with Pennsylvania seeing overall the lowest amount of power outages. 
...
```{r CAcwhtrend, fig.cap="Trend versus observation of customer weighted hours in Texas (2015-2023)."}
