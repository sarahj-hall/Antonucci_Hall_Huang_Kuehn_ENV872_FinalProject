...
Each state’s non-seasonal power outage time series trend are visualized in Figure \@ref(fig:trendall). Red represents California, green is Florida, purple is Pennsylvania, and blue is Texas. All states are seeing an increasing trend of power outages. California and Texas are experiencing the greatest increase, while Pennsylvania and Florida are experiencing more gradual increases in comparison. Towards the end of the time period, California and Texas also overall have more power outages than Florida and Pennsylvania, with Pennsylvania seeing overall the lowest amount of power outages. 

```{r trendall, fig.caption="Non-seasonal trend of power outages in California, Florida, Pennyslvania, and Texas."}
