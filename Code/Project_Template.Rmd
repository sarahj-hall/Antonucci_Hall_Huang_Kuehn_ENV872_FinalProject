...
first_month_FL <- first(monthly_outages_FL$month)
first_year_FL <- first(yearly_outages_FL$year)
...
```{r FLnonseasonal, fig.cap = "FL Nonseasonal Trend Analysis for Monthly Outages"}
...
The visualization highlights a potential pattern of power outage frequencies peaking rising in the summer months, peaking in October (Figure \@ref(fig:CAseasonal)). However, the frequency of outages in California was not significantly different among the months (ANOVA; df = 11, F = 0.704, p < 0.732). 
