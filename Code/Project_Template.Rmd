...
Figure \@ref(fig:seasall) displays the seasonal cycle for each state. This was created by aggregating the monthly power outage data of every year to show cumulative trend across 2015 to 2023. Florida and Pennyslvania have very similar seasonal cycles, with a concentration of outage occurrences in summer months (peaking in July), and a significant decline in winter months. Texas appears to peak earlier in May. California has a less discernible trend, but there is a peak in October. [ADD SECTION COMPARING ANOVA P-VALUES!] [LINK TO CLIMATE??, CA fire season is really all over the place? interesting that TX doesn't have an uptick from winter storms, but it also experiences hurricanes like FL. Summer peak could be largely from heatwaves and hurricanes, generally  energy demand peaks in the summer with AC usage]
...
nonseas_cwh_combined <- nonseas_cwh_combined_data %>% 
  ...
  "CA" = "red",
  "PA" = "purple",
  "FL" = "darkgreen"))#add once TX is in  "TX" = "blue",
