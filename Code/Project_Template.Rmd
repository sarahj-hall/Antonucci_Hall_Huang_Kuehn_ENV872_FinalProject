...
\newpage
### Florida 
Results from the time series for outages in FL displayed a pattern of seasonality. To further analysis the strength of that trend, months of every year were aggregated to show a cumulative trend across 2015 to 2023 in Figure \@ref(fig:FLseasonal). A clear normal distribution shows a concentration of outage occurrences in summer months, and a significant decline in winter months. This is statistically proven with an ANOVA test that confirms outage counts between months vary significantly, following a seasonal trend (Df = 11, F-value = 43.28, p < 2e-16).
