...
Duration_ts_PA <- ts(
  ...
  start = c(year(min(monthly_duration_PA$year_month)),
  month(min(monthly_duration_PA$year_month))),
  frequency = 12)
...
#Mann-Kendall Seasonality Test
Duration_MK_PA <- trend::smk.test(Duration_ts_PA)
Duration_MK_PA
summary(Duration_MK_PA)
