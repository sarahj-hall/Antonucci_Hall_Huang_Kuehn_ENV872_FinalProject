...
ggsave(here('Output/CA_monthly_plot.jpg'), CA_monthly_plot, height = 4, width = 6, units = "in", dpi = 300)

#plots for Texas, monthly 
outage_group_TX %>% 
  filter(month != 0) %>% 
  ggplot(
    mapping = aes(
 ...
 scale_color_viridis(
   ...
   direction = -1)+
  labs(
    title = "Number of Power Outages in Texas by Month from 2015 to 2023",
    y = "Number of Outages",
    x = "Month",
    color = "Year",
  )
...
outage_group_PA %>% 
 ...
 scale_color_viridis(
   ...
   direction = -1)+
  labs(
    title = "Number of Power Outages in Pennslyvania by Month from 2015 to 2023",
    y = "Number of Outages",
    x = "Month",
    color = "Year",
  )
