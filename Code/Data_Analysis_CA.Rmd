...
anova_outage <- aov(outage_count ~ month, data = outage_group_CA)
summary(anova_outage)
...
PAanova_outage <- aov(outage_count ~ month, data = outage_group_PA)
summary(PAanova_outage)
```
