...
#messing around with PA stats for seasonality (results so stats sig)
...
#messing around with FL stats for seasonality (results so stats sig)
...
#messing around with TX stats for seasonality (results so stats sig)
...
outage_trend_vis_CA <- ggplot(CA_outage_components) +
  ...
  geom_line(aes(y = trend, x = Date), color = "red") + #trend component (pink)
