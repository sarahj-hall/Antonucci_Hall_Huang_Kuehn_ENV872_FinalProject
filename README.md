...
The dataset was downloaded from the Open Energy Data Initiative (OEDI), and the outage data set version 2 was accessed 11/15/2025. This data set is located in the Data/Raw folder. Processed data was wrangled in RStudio and written into Data/Processed folder in the repository.  
